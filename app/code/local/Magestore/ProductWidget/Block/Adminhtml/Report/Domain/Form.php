...
class Magestore_ProductWidget_Block_Adminhtml_Report_Domain_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('domain','select',array(
            'name' => 'domain',
            'options' => Mage::getSingleton('productwidget/action')->getDomainOptionArray(),
            'label' => Mage::helper('reports')->__('Domain'),
            'title' => Mage::helper('reports')->__('Domain')
        ));
