...
class Magestore_ProductWidget_Block_Adminhtml_Report_Domain_Result extends Mage_Adminhtml_Block_Template
{
   ...
   public function getDomainReport(){
      ...
      $data =  Mage::getResourceSingleton('productwidget/action')->getVCSReport('domain',$filter);
      Mage::register('report_data',$data);
      return json_encode($data);
   }

   public function getDomainRateReport(){
